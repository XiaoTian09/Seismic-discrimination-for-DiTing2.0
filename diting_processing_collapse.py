# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 10:33:09 2024
...
print(len(non_natural_datas_norm))
#plt.imshow(non_natural_datas_norm)
np.save('./data/non_natural_datas_collapse.npy',non_natural_datas_norm)
